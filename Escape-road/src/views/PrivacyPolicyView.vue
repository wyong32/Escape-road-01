  ...
  <main class="privacy-page">
    ...
    <section class="content-wrap">
      <div class="privacy-container">
        ...
        <ul>
          <li>Email address (if you provide it, e.g., for comments or contact)</li>
          <li>Name (if you provide it, e.g., for comments)</li>
        ...
        <ul>
            ...
            <li><strong>Advertising Cookies.</strong> Advertising Cookies are used to serve you with advertisements that may be relevant to you and your interests (if applicable).</li>
        </ul>
        ...
        <ul>
            ...
            <li>To allow you to participate in interactive features of our Service when you choose to do so (e.g., comments)</li>
        ...
        <p>
          If you are located outside [Your Country/Region] and choose to provide information to us, please note that we transfer the data, including Personal Data, to [Your Country/Region] and process it there.
        </p>
        <p>
        ...
        <ul>
            ...
            <li>To protect and defend the rights or property of [Your Website Name]</li>
        ...
        <p>
          (Example: Analytics - We may use third-party Service Providers to monitor and analyze the use of our Service, such as Google Analytics.)
        </p>
...
<style scoped>
/* 样式与 AboutView/DmcaView 类似，可以复用或调整 */
.privacy-page {
  display: flex;
